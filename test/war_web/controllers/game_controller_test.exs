defmodule WarWeb.GameControllerTest do
  use WarWeb.ConnCase

  alias War.GamePlay

  @create_attrs %{status: "some status", won: true}
  @update_attrs %{status: "some updated status", won: false}
  @invalid_attrs %{status: nil, won: nil}

  def fixture(:game) do
    {:ok, game} = GamePlay.create_game(@create_attrs)
    game
  end
